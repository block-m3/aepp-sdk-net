...
{
    public class ChannelSnapshotSoloTransaction : Transaction<UnsignedTx, ChannelSnapshotSoloTx>
    {
        internal ChannelSnapshotSoloTransaction(ILoggerFactory factory, FlatClient client) : base(factory, client)
        {
        }
        ...
        {
            return _client.CreateDebugChannelSnapshotSoloAsync(Model, token);
        }
